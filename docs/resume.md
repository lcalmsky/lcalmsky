...
- 윈도우 콘솔 솔루션을 webOS 형식으로 제공하기 위한 클라우드 구축 및 개발
  - 클라우드설계및구축 스프링 클라우드 사용 -클라우드서버개발
- 마이크로 서비스 개발 OS서비스서버개발 리포트 서비스 서버 개발 이벤트로그서비스서버개발 IP탐지서비스서버개발
- 라이브러리 개발 서비스에서 공용으로 사용할 라이브러리 개발(validation, message source 등)
- 성능 측정 라이브러리 개발(JNI)

### 헤리트

###### 2014.03 - 2017.04 / IoT 플랫폼팀 / 대리
